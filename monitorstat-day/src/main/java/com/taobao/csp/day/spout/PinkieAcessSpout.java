...
import com.taobao.csp.day.base.LocalFileOutputter;
import com.taobao.csp.day.base.Log;
import com.taobao.csp.day.pinkie.PinkieAccessTaskCenter;
 ...
 *
 */
public class PinkieAcessSpout implements IRichSpout {
	
	public static Logger logger = Logger.getLogger(PinkieAcessSpout.class);
	...
	public PinkieAcessSpout(int order, int spoutNum) {
	...
	public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
		...
		PinkieAccessTaskCenter.getInstance().registThreadPool(pool);
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(new Fields(PinkieLog.getKeys()));
	}
