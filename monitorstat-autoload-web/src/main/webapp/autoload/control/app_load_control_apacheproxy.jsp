...
<% request.setAttribute("title","apacheProxy压测控制"); %>
					...
					<form
						...
						<table  id="myTable" >
							<tr>
								<td>
									IP地址：
									<input type="text" value="" name="targetip" />
								</td>
								<td>
									目标：
									<input type="text" value="2100:4" name="split_target" />
								</td>
							</tr>
							<tr>
								<td>
									apache代理比例(本地)：
									<input type="text" value="2200:4" name="split_local" />
								</td>
								<td align="left">
