...
<body>
<h2 align="center">提供HSF的center应用报表</h2>
	...
	<%
		...
		%>
			<tr>
				...
				<td><a href="hsfconsume.do?method=showAppCenterConsumeHsfInfo&opsName=<%=appName%>&selectDate=${selectDate}" target="_blank">查看详细</a></td>
			</tr>	
		<%
		}
	%>
