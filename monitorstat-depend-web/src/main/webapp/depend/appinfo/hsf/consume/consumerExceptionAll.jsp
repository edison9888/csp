...
<body>
	<table  width="100%">
		<tr>
			<td><h3><%=opsName%>应用调用其他应用的HSF服务时，异常情况(收集时间：<%=selectDate%>)</h3></td>
		</tr>
		<tr>
			<td>
					...
					<% 
				  	...
				  	%>
						<tr>
							...
							<td align="center"><a href="javascript:openWin('<%=request.getContextPath()%>/show/hsfconsume.do?method=showAppHsfExceptionDetail&opsName=${opsName}&selectDate=${selectDate}&customerName=<%=excepInfo.getCustomerApp()%>',700,1100)">查看详细</a></td>
						<tr>
					<% } %>
				</table>
			</td>
