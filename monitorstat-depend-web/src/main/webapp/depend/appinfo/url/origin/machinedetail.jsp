...
Map<String, UrlOriginDetail> ipMap = (Map<String, UrlOriginDetail>)request.getAttribute("ipMap");
...
<H2 align="left">对比时间：${selectPreDate}</H2>
	...
	<table class="table table-striped table-bordered table-condensed"  width="100%" style="margin-bottom: 20px">
		...
		<%for(UrlOriginDetail m: ipMap.values()){
			long callNumber = m.getOriginUrlNum();	//当前数量
			%>
		<tr>
