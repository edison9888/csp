...
<script>
	$("#page_nav").load('<%=request.getContextPath()%>/page_nav.jsp', {urlPrefix:'<%=request.getContextPath()%>/app/detail/tddl/consumer/show.do?method=showIndex&appId=',appId: '${appInfo.appId}'});
</script>	
	...
	<div class="row-fluid">
		...
		<div class="span12">
			...
			-><a href="<%=request.getContextPath()%>/app/detail/tbsession/show.do?method=showIndex&appId=${appInfo.appId}">Tbsession信息</a>
			->${keyName}操作
			<hr>
			<div class="row-fluid">
