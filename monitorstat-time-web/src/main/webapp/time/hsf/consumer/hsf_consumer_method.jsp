...
<script type="text/javascript">
	function query(){
		...
		$.ajax({
			url : "<%=request.getContextPath()%>/app/detail/hsf/consumer/show.do?method=queryhsfConsumerMethod&appId=${appInfo.appId}&key=${param.key}",
	...
	var  for_popover_map = {};
				for(var n=0;n<data.length;n++){
					...
					tr+="<td style='text-align:center;'><a href='<%=request.getContextPath()%>/app/detail/hsf/consumer/show.do?method=gotohsfConsumerMethodHost&appId=${appInfo.appId}&key="+row.fullKeyName+"'>查看</a></td>";
