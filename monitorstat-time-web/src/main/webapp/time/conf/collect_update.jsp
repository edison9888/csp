						...
						<div class="span12">
							<div class="row">
								<div class="span10 ">
									...
									<form action="<%=request.getContextPath()%>/app_info.do?method=collectUpdate" method="post">
										
										<%
												TimeConfPo tmp = (TimeConfPo)request.getAttribute("confPo");
										 %>
										 <input type="hidden" name="appId" value="${appInfo.appId }"/>
										<input type="hidden" name="tmpConfigId" id="tmpConfigId" value="<%=tmp.getConfId() %>"/></td>
										...
										<input type="submit" value="&nbsp;更&nbsp;&nbsp;新&nbsp;" id="btnAdd" class="btn-primary">
										</div>
									</form>
								</div>
							</div>
