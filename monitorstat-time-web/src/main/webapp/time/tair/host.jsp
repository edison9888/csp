...
<div class="row-fluid">
	<div class="span12">
		<table class="table table-striped table-bordered table-condensed" id="appTairHostConsumerTable">
			<caption>
				<strong>${appInfo.appName }主机 依赖的tair分组</strong>
			</caption>
			<thead>
						<tr>
...
function query(){
		...
		$.ajax({
			url : '<%=request.getContextPath()%>/app/detail/tair/show.do?method=queryHost&appId=${appInfo.appId}',
			success : function(data) {
				...
				for(var n=0;n<data.length;n++){
					...
					tr+="<td  style='text-align:center;' ><a href='<%=request.getContextPath()%>/app/detail/tair/show.do?method=gotoHostGroup&appId=${appInfo.appId}&ip="+row.ip+"'>查看</a></td>";
