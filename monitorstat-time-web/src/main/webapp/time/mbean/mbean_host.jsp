...
<script>
	...
	<div class="row-fluid">
		...
		<div class="span12">
			<a href="<%=request.getContextPath()%>/index.jsp">实时首页</a> -><a href="<%=request.getContextPath()%>/app/detail/show.do?method=showIndex&appId=${appInfo.appId}" >${appInfo.appName}</a> -><a href="<%=request.getContextPath()%>/app/detail/mbean/show.do?method=showIndex&appId=${appInfo.appId}">mbean</a>->${keyname}
			<hr>
			<div class="row-fluid">
				<h4>${keyname}每台机器</h4>
