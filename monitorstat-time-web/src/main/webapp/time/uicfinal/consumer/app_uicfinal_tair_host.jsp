...
<script>
	...
	<div class="row-fluid">
		...
		<div class="span12">
			...
			-><a href="<%=request.getContextPath()%>/app/detail/uicfinal/consumer/show.do?method=showIndex&appId=${appInfo.appId}">uicfinal信息</a>
			->namespace : ${keyName}
			<hr>
			<div class="row-fluid">
				<table class="table table-striped table-bordered table-condensed"  width="100%">
					...
					<tbody id="exctbody">
						...
						%>
							<tr>
								<td style="text-align:center;" width="250" rowspan="2"><%=ip %></td>
								<%
								for(String time:timeList){ 
								...
								<td style="text-align:center;" rowspan="2"><a target='_blank' title='查看历史调用量' href='<%=request.getContextPath()%>/app/detail/history.do?method=showHistoryByip&appName=${appInfo.appName}&keyName=<%=se.getKeyName()%>&ip=<%=ip%>'>查看</a></td>
							</tr>
							<tr>
								<%
								for(String time:timeList){ 
