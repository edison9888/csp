...
<script>
	...
	<div class="row-fluid">
		...
		<div class="span12">
			...
			<a href="<%=request.getContextPath()%>/app/detail/exception/show.do?method=showIndex&appId=${appInfo.appId}">异常信息</a>->${exception }
			<hr>
			<div class="row-fluid">
				<h4>${appInfo.appName}的${exception }每台机器信息(点击数字可以看异常内容)</h4>
