...
<tbody>
	...
	for(String appid : appList) {
		...
		<td align='center'>
		<a href="javascript:selectKey('<%=appid %>')">查看已关联的告警key</a>&nbsp;&nbsp;
...
<div id="dialog_appRel_add" title="dialog">
	<iframe id="iframe_appRel_add" src="" frameborder="0" height="550" width="400" marginheight="0" marginwidth="0" scrolling="yes" ></iframe>
</div>

<script type="text/javascript">

$("#dialog_appRel_add").dialog({bgiframe: false,height: 600,width:450,modal: true,draggable:false,resizable:false,autoOpen:false});
//添加告警应用
