...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/statics/js/buy-init.js"></script>
		...
		<div id="header">
			...
			<div class="menulist">
               <ul>
                   ...
                   <li><a class="selected" href="./tf_buy_relate.jsp">buy监控页</a></li>
	...
	<div class="flashwrapper">
		<div id="flashdiv">
			<object id="flashobj" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="1024" height="768">
				...
				<param name="movie" value="flash/tf_buy.swf">
				<param name="quality" value="high">
				<param name="menu" value="false">
				<param name="wmode" value="transparent">
				<embed src="flash/tf_buy.swf" wmode="transparent" menu="false" quality="high" width="1024" height="768" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" name="flashobj">
			</object>
...
<!-- end help board -->
<div id="appId"><%=AppInfoAo.get().getTfBuyRelateAppMap().get("tf_buy") %></div>
