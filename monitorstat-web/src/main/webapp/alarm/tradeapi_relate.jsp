...
<head>
	...
	<title>交易平台关联tradeapi(交易topapi)监控图</title>
	...
	<!-- so many script for time picker below -->
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/statics/js/tradeapi-init.js"></script>
		...
		<div id="header">
			...
			<div class="menulist">
               <ul>
                   ...
                   <li class="menutail"><a class="selected" href="./tradeapi_relate.jsp">Tradeapi</a></li>
               </ul>
		  	</div>
		</div>
	...
	<div class="flashwrapper">
		<div id="flashdiv">
			<object id="flashobj" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="1024" height="768">
				...
				<param name="movie" value="flash/tradeapi.swf">
				<param name="quality" value="high">
				<param name="menu" value="false">
				<param name="wmode" value="transparent">
				<embed src="flash/tradeapi.swf" wmode="transparent" menu="false" quality="high" width="1024" height="768" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" name="flashobj">
			</object>
...
<!-- end help board -->
<div id="appId"><%=AppInfoAo.get().getTradeplatformRelateAppMap().get("tradeapi")!=null?AppInfoAo.get().getTradeplatformRelateAppMap().get("tradeapi"):414 %></div>
