...
<head>
    ...
    <title>交易平台关联拍卖系统AuctionPlatform监控图</title>
    ...
    <script type="text/javascript" src="<%=request.getContextPath() %>/statics/js/auctionplatform-init.js"></script>
...
<div id="container">
    ...
    <div id="banner">
        <div id="movingboard">
            <div id="header">
                <div class="title"><a class="hidelink" href="./trade_alarm_relate.jsp" title="回到监控首页">交易平台关联监控系统</a></div>
                <div class="menulist">
                    <ul>
                        <li><a href="./index.jsp" target="_blank">首页</a></li>
                        <li><a id="ascreen" href="#" onClick="return false;">ap监控屏</a></li>
                        ...
                        <li><a class="selected" href="./auctionplatform_relate.jsp">拍卖ap监控</a></li>
    ...
    <div class="flashwrapper">
        <div id="flashdiv">
            <object id="flashobj" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="1024" height="800">
                <param name="allowScriptAccess" value="sameDomain">
                <param name="movie" value="flash/auction.swf">
                <param name="quality" value="high">
                <param name="menu" value="false">
                <param name="wmode" value="transparent">
                <embed src="flash/auction.swf" wmode="transparent" menu="false" quality="high" width="1024" height="864" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" name="flashobj">
            </object>
        </div>
    </div>
</div>
...
<!-- end help board -->
<div id="appId"><%=AppInfoAo.get().getAuctionplatformRelateAppMap().get("auctionplatform") %></div>
