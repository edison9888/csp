...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/statics/js/cart-init.js"></script>
		...
		<div id="header">
			...
			<div class="menulist">
               <ul>
                   ...
                   <li><a class="selected" href="./cart_relate.jsp">cart监控页</a></li>
	...
	<div class="flashwrapper">
		<div id="flashdiv">
			<object id="flashobj" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="1024" height="768">
				...
				<param name="movie" value="flash/cart.swf">
				<param name="quality" value="high">
				<param name="menu" value="false">
				<param name="wmode" value="transparent">
				<embed src="flash/cart.swf" wmode="transparent" menu="false" quality="high" width="1024" height="768" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" name="flashobj">
			</object>
...
<!-- end help board -->
<div id="appId"><%=AppInfoAo.get().getCartRelateAppMap().get("cart") %></div>
