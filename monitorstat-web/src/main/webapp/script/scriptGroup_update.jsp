...
<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">更新脚本组的基本信息</div>
...
<table width="100%">
	<tr>
		...
		<input type="submit" value="更新"><input type="button" value="返回" onclick="location.href='./scriptGroup_manager.jsp'"></td>
	</tr>
</table>
</form>
<%} %>
