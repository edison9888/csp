...
<%@page import="com.taobao.monitor.web.jprof.ScpAccept"%>

<%@page import="com.taobao.monitor.web.jprof.AutoJprofManage"%><html>
<head>
...
ScpAccept scp = new ScpAccept(h);
scp.getRemoteFile(h.getFilePath(),AutoJprofManage.get().getLocalTmpPath(h,AutoJprofManage.get().getUploadCollectDay()));
