...
<%@page import="com.taobao.monitor.web.ss.SsdetailReportManagerNetty"%>
	...
	<tr>
		...
		<table border="1" >
			...
			<%
			    ...
			    List<StableSwitchGroup> ssgs = SsdetailReportManagerNetty.report(app, "7001", "/command.sph?command=show");
			...
			<%
				...
				System.out.println("report on indexNetty.jsp:"+(endTime-startTime));
			%>
		</table>
		</td>
