...
<a href="?app=buy">buy</a>
<a href="?app=hesper">hesper</a>
<a href="?app=trademgr">trademgr</a> 
&nbsp;
&nbsp;<a href="">脚本控制台</a>
</h3><br>
<table >
	<tr>
		...
		<table border="1" width="400">
			...
			<%
				String collectIPs = SsdetailReportManager.CollectIPs(app);
				StableSwitchGroup ssg = SsdetailReportManager.reportOne(app,"7001","/command.sph?command=show");
				List<StableSwitch> sss = ssg.getStableSwitchs();
