...
<table width="100%" border="1">
	<tr>
		...
		<table width="100%" border="1" class="ui-widget ui-widget-content">
			...
			<tr>
			<td align="center"><a target="_blank" href="<%=request.getContextPath () %>/time/key_detail_time_table.jsp?appId=<%=appId%>&keyId=167&aimName=FullGC&collectTime1=<%=collectTime1%>"><img src="<%=request.getContextPath () %>/statics/images/report.png"/></a><%=curFullNum %></td>
