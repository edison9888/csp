<%@ page language="java" contentType="text/html; charset=GBK"
    pageEncoding="GBK"%>
<%@ page import="com.taobao.monitor.web.ao.MonitorCommonAo"%>
...
<%@page import="com.taobao.monitor.web.vo.PvUrlPo"%><html>
<head>
...
List<KeyPo> keyList = MonitorCommonAo.get().findAllKey("URLPV");
String urlname = "";
String siteName = "";
%>
...
function goToDetailMonitor(){
	...
	location.href="./pv_url_detail.jsp?keyId="+keyid+"&appName=<%=appName%>";
}
function goToComparedDetailMonitor(){
	var keyid = $("#keySelect").val();
	var collectTime2 = $('#datepicker').val();	
	location.href="./pv_url_detail.jsp?keyId="+keyid+"&appName=<%=appName%>&collectTime1=<%=collectTime1%>&collectTime2="+collectTime2;
}
		...
		<tr>
		   <td align="center">
			...
			for(KeyPo keyPo:keyList){
				...
				String[] _url = url.split("_");
				
				String name =_url[_url.length-1];
				if(!name.equals(appName)){
					continue;
				}
				tmpKeyId = keyPo.getKeyId()+"";
			%>
