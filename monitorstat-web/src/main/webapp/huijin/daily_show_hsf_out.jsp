...
<table width="100%" border="1" class="ui-widget ui-widget-content">
	...
	<%
		...
		Map<String, List<HsfClass>> tongbiSortOutMap = tongqiVo.getSortOutHsfMap1();
		Map<String, List<HsfClass>> huanbiSortOutMap = huanbiVo.getSortOutHsfMap1();
		...
		while(sortOutMapit.hasNext()){
			...
			for(HsfClass hc:hsfClassList){
				...
				%>					
				<tr>
					<td align="left" style="font-size:12px"><%=aimShow?po.getAim():" - " %></td>			
