...
<script type="text/javascript">
	function mbeanFrame(mBeanType){
			document.getElementById("mbeanFrame").src="../time/show_mbean_common.jsp?appId=<%=appId%>&mBeanType="+mBeanType;
	}
</script>
</head>
<body>
	...
	<tr>
		<td width="50%" >
			<table>
				...
				<tr>
					<td><iframe id="mbeanFrame" src="../time/show_mbean_common.jsp?appId=<%=appId%>&mBeanType=SELF_DataSource_" frameborder="0" height="340" width="100%" marginheight="0" marginwidth="0" scrolling="no"></iframe></td>
				</tr>
			</table>
		</td>
		<td width="50%" >
			<iframe src="../time/show_mbean_memory.jsp?appId=<%=appId%>" frameborder="0" height="340" width="100%" marginheight="0" marginwidth="0" scrolling="no"></iframe>
		</td>
	</tr>	
</table>
</div>
