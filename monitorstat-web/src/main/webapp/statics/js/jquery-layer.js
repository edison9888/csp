...
$.extend({
	layerSettings:{
		...
		width:762,//设置宽度
		height:650,
		templete:'<div class="showwint_mini_title" style="border:solid #C1D2E9 1px;width:@width@px; background-color:#777777;"><span id="@moveid@" style="position:relative; left:0px; top:0px;font-size: 12px;font-weight : bold;"><span id="@titleid@">@title@</span></span><span class="layerclose" style="position:relative; top:0px; float:right; right:20px; color:blue;font-size: 12px;font-weight : bold;"><a <a href="#" style="cursor:hand">关闭</a></span></div><div class="showwint_mini_content" style="border:solid #C1D2E9 1px; width:@width@px; height:@height@px;"><div class="showwint_mini_content_content" style="width:100%; height:100%; background-color:#ffffff;" id="@contentid@"></div></div>',
		content:'',
		title:'',
		isbg:true,
		opacity:0.3
