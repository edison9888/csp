...
<%@page import="com.taobao.monitor.common.util.*"%><html>
<head>
...
*/
%>
<form action="./server_rel_app_day_add.jsp" onsubmit="return checkAlarm()"  method="post" name="myform" id="myform">
<%
...
if("add".equals(action)){
	...
	List<AppInfoPo>  appList = AppInfoAo.get().findAllAppWithoutServerRel("day");
