								...
								$("#database-table tbody").append( 
										...
										"<td align='left'>" + json.databaseUrl + "</td>" +	
											"<td align='center'>" +
												...
												"<a href='./rel_app_day.jsp?appId=" + json.appId + "&databaseId=" + json.databaseId + "&appType=" + json.appType + "&action=deleteDbRel>删除</a>&nbsp;&nbsp;" + 
											"</td>" +
										"</tr>" );
							...
							if (json != "ERROR" && json.isSuccess != "false") {
								$("#server-table tbody").append( 
										...
										"<td align='center'>" + json.serverIp + "</td>" +
											...
											"<a href='./rel_app_day.jsp?appId=" + json.appId + "&serverId=" + json.serverId + "&appType=" + json.appType + "&action=deleteServerRel>删除</a>&nbsp;&nbsp;" + 
										"</td>" +		
										"</tr>" );
...
<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">应用【<%=appInfoPo.getAppName() %>】日报配置界面
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="demo1">
<div id="dialog-form-db-add" title="添加新的数据库关联">
...
<!--修改数据库的弹出框 -->
<div class="demo2">
<div id="dialog-form-db-modify" title="修改数据库关联">
...
<div class="demo1">
<div id="dialog-form-server-add" title="添加新的服务器关联">
...
<!--修改服务器的弹出框 -->
<div class="demo2">
<div id="dialog-form-server-modify" title="修改服务器关联">
...
%>
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all " style="width: 100%;">
<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">关联日报配置信息  :
<button id="btn-add-day">添加日报配置</button></div>
<div id="dialog" class="ui-dialog-content ui-widget-content">
...
<table id="dayConf-table" align="center" width="400" border="1" class="ui-widget ui-widget-content">
	<thead>
		<tr>
			<td align="center" width="98">实时配置文件名</td>
			<td align="center" width="395">实时配置文件路径</td>
			<td align="center" width="120">实时配置文件分析器</td>
	...
	<tbody>
		...
		<tr>
			...
			<td align="center">
				<a href="javascript: openDialogModifyDayConf(<%=po.getConfId()%>,<%=po.getAppId() %>);">修改</a>&nbsp;&nbsp;
				<a id="deleteAction" class="deleteAction" href="./rel_app_day.jsp?confId=<%=po.getConfId()%>&appId=<%=po.getAppId() %>&appName=<%=AppCache.get().getKey(po.getAppId()).getAppName() %>&action=deleteDayConfRel">删除</a>&nbsp;&nbsp;
			</td>
		</tr>
...
<table align="center" width="400" border="1" class="ui-widget ui-widget-content">
	...
	<tr>
		...
		<td><a target="_blank" href="./rel_app_host_check1.jsp?appId=<%=appId %>&appName=<%=appName %>&opsName=<%=opsName %>&site=CM3&type=day">查看设置</a>&nbsp;&nbsp;</td>
	...
	<td><a target="_blank" href="./rel_app_host_check1.jsp?appId=<%=appId %>&appName=<%=appName %>&opsName=<%=opsName %>&site=CM4&type=day">查看设置</a>&nbsp;&nbsp;</td>
...
<!-- 修改日报配置的弹出框 -->
<div id="dialog_day_modify" title="修改日报配置">
