...
if("update".equals(action)){
	...
	boolean b = DayConfAo.get().updateDayConfTmp(po);
...
<table align="center" width="400" border="1" class="ui-widget ui-widget-content">
	...
	<tr>
		<td>分析器: </td>
		<td><input type="text" name="analyseClass" size="100" value="<%=po.getClassName() %>"></td>
	</tr>
	<tr>
		<td>文件路径: </td>
		<td><input type="text" name="filePath" size="100" value="<%=po.getFilePath() %>"></td>
	</tr>
