...
//	String appType = request.getParameter("appType");
	...
	<a href="./server_info_center.jsp">返回</a>
	<%
}else{
...
<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">添加服务器的基本信息</div>
...
<table width="100%">
	<tr>
		<td align="center"><input type="hidden" value="add" name="action"><input type="submit" value="添加新服务器"><input type="button" value="关闭" onclick="window.close()"></td>
	</tr>
</table>
</form>
<%} %>
