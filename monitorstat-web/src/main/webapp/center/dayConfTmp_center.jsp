...
<input type="button" value="添加新的日报配置模板" onclick="location.href='./dayConfTmp_add.jsp'">
<input type="button" value="返回" onclick="location.href='./manage_center.jsp'">
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all " style="width: 100%;">
<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">日报配置模板列表</div>
...
<table width="100%" border="1" class="ui-widget ui-widget-content" id="userInfoTableId">
	...
	<tr >
		...
		<td>
			<a href="./dayConfTmp_update.jsp?id=<%=po.getTmpId()%>">修改</a>&nbsp;&nbsp;
			<a id="deleteAction" class="deleteAction" href="./dayConfTmp_center.jsp?id=<%=po.getTmpId() %>&action=delete">删除</a> &nbsp;&nbsp;
			<a href="./dayConfTmp_check.jsp?id=<%=po.getTmpId() %>">查看</a> &nbsp;&nbsp;
		</td>
	</tr>
	<%} %>
</table>
