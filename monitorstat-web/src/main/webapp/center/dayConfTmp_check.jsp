...
<%
	...
	DayConfTmpPo po = DayConfAo.get().findDayConfTmpById(Integer.parseInt(id));
%>
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all " style="width: 100%;">
<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">查看日报配置模板的基本信息</div>
...
<table align="center" width="400" border="1" class="ui-widget ui-widget-content">
	...
	<tr>
		<td>分析器: </td>
		<td><input type="text" name="analyseClass" value="<%=po.getClassName() %>"></td>
	</tr>
	<tr>
		<td>行分隔符: </td>
		<td><input type="text" name="split" value="<%=po.getSplitChar() %>"></td>
	</tr>
	<tr>
		<td>文件路径: </td>
		<td><input type="text" size="100" name="filePath" value="<%=po.getFilePath() %>"></td>
	</tr>
