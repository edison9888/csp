...
<%@page import="com.taobao.monitor.common.po.DatabaseAppRelPo"%>
...
relPo.setDatabaseId(Integer.parseInt(id));
...
<a id="addIframe" href="./db_rel_app_time_add.jsp?databaseId=<%=id %>" STYLE="text-decoration:underline"><font color='red'>-->添加应用关联</font></a> &nbsp; 
</div>
<div id="dialog" class="ui-dialog-content ui-widget-content">
<%
List<AppInfoPo> appList = AppInfoAo.get().findAllAppByDatabaseIdAndAppType(Integer.parseInt(id),"time");
...
<table width="100%" border="1" class="ui-widget ui-widget-content" id="userInfoTableId">
	...
	<tr >
		...
		<td align="center"><a id="deleteAction" class="deleteAction"  href="./db_rel_app_time_center.jsp?appId=<%=po.getAppId() %>&databaseId=<%=id %>&action=delete">删除</a></td>
