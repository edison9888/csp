...
<style type="text/css">
            body{font-size:12px;font-family:Verdana,Arial,"宋体";} a:link {color:#464646;text-decoration:none;}
            a:visited {color:#464646;text-decoration:none;} a:hover{color:#ed145b;text-decoration:underline;}
            a:active{color:#ed145b;text-decoration:underline;} td{font-size:12px} /*DateCSS样式*/
		...
		<form action="./add_optimize_record.jsp" method="post"  onsubmit="return checkSubmit()">
			<div class="ui-dialog ui-widget ui-widget-content ui-corner-all "
				...
				<div
					...
					<font color="#FF0000">请输入优化记录：</font>&nbsp;&nbsp;
				</div>
