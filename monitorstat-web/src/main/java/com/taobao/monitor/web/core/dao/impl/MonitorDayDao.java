...
import com.taobao.monitor.web.vo.AppSqlInfo;
import com.taobao.monitor.web.vo.DataSourcePo;
import com.taobao.monitor.web.vo.ForestPo;
import com.taobao.monitor.web.vo.GcPo;
...
import com.taobao.monitor.web.vo.PageCachePo;
import com.taobao.monitor.web.vo.PingPo;
import com.taobao.monitor.web.vo.SearchEnginePo;
import com.taobao.monitor.web.vo.SqlTop10Po;
import com.taobao.monitor.web.vo.TableRecord;
import com.taobao.monitor.web.vo.TairClientPo;
import com.taobao.monitor.web.vo.ThreadPo;
import com.taobao.monitor.web.vo.ThreadPoolPo;
...
public class MonitorDayDao extends MysqlRouteBase {
	...
	public Map<Integer, MonitorVo> findMonitorCountMapByDate(String date) throws Exception {		
		return findMonitorCountMapByDate(null,date);
	}
...
//}
	 ...
	 * @throws Exception
	 */
	public Map<Integer, MonitorVo> findMonitorCountMapByDate(Integer appId,String date) {
			...
			this.query(sql,obj, new SqlCallBack(){
				...
				public void readerRows(ResultSet rs) throws Exception {
						...
						try{
							...
							String appName = AppCache.get().getDayAppId(app_id).getOpsName();							
							if(app_id==10){
								appName = "tbdb1";
							}
							if(app_id==11){
