...
public class RealTimeTradeTask extends TimerTask {
	...
	//http://10.232.10.195:8080/sharereport/sumRealTimeTrade.do?start=2011-11-07T05:00:00&end=2011-11-07T05:01:00&interval=second;
	...
	public void run() {
		...
		sbCreate.append("start=").append(sdfTime.format(start)).append("&end=").append(sdfTime.format(start)).append("&interval=second&invalid=true");
