...
function change() {
	...
	var urlDest = "info.do?method=whiteListInterface";
...
function viewIps() {
	...
	var url = "info.do?method=ipsWhiteListInterface&appName=" + appName + "&interfaceInfo=" + interfaceInfo;
	window.open(url,"_self");
}
	
function efficientConfig(ip, interfaceInfo, appName) {
 	var urlAddr = "configFeedback.do?method=checkWhiteListInterface&ip=" + ip + "&interfaceInfo=" + interfaceInfo + "&appName=" + appName;
...
function result(ip, interfaceInfo, appName) {
	var urlAddr = "resultFeedback.do?method=resultWhiteListInterface&ip=" + ip + "&interfaceInfo=" + interfaceInfo + "&appName=" + appName;
 	window.open (urlAddr, 'newwindow', 'scrollbars=yes, height=600, width=900, top=150, left=150');
}
