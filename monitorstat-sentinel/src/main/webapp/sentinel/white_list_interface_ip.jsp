...
<table class="bordered-table"  id="mytable" >
      ...
      <c:forEach items="${whiteListIps}" var="o">
      <tr>
...
function add() {
	window.open ('manage.do?method=goToAddWhiteListApp', 'newwindow', 'height=600, width=900, top=150, left=150')
}
