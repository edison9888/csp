...
public class Calculations {
     ...
     *
     * @see com.taobao.csp.hadoop.job.gclog.utils.Calculations#perc(double, double)
     * @see com.taobao.csp.hadoop.job.gclog.utils.Calculations#perc(Number, Number)
     */
     ...
     *
     * @see com.taobao.csp.hadoop.job.gclog.utils.Calculations#perc(double, double)
     * @see com.taobao.csp.hadoop.job.gclog.utils.Calculations#perc(int, int)
     */
     ...
     * form 100 * (<tt>value</tt> - <tt>base</tt>) / <tt>base</bb>.
     *
     * @see com.taobao.csp.hadoop.job.gclog.utils.Calculations#percDiff(double, double)
     */
     ...
     * form 100 * (<tt>value</tt> - <tt>base</tt>) / <tt>base</bb>.
     *
     * @see com.taobao.csp.hadoop.job.gclog.utils.Calculations#percDiff(Number, Number)
     */
