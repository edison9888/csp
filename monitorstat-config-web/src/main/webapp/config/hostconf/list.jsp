...
<html>
	<head>
		...
		<script src="${base }/config_res/hostconf/list.js"></script>
			...
			<div class="content">
				<div class="row" style="padding-bottom: 10px">
					<div class="span18" style="text-align: right">
						<a class="btn  primary " href="${base }/hostconf/edit.do">添加新的服务器</a>
					</div>
						...
						<table class="zebra-striped condensed-table bordered-table" id="table1">
							<thead>
								<tr>
									...
									<th class="so_serverName blue">
										服务器名
									</th>
									<th class="so_serverIp blue">
										IP
									</th>
