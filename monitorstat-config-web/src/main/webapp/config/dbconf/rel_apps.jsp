...
<html>
	...
	<%@ include file="/common/base.jsp"%>
		...
		<link href="../../common_res/css/bootstrap.css" rel="stylesheet">
		<script src="../../common_res/js/jquery.js"></script>
		<!-- bootstrap begin -->
		<script src="../../common_res/js/bootstrap-alerts.js"></script>
		<!-- bootstrap begin -->

		<script src="../../common_res/js/jquery.tablesorter.js"
			charset="utf-8"></script>

		<!-- 弹窗效果 -->
		<script src="../../common_res/js/tinybox.js"></script>


		<script src="../../config_res/dbconf/rel_apps.js"></script>
		<script>
	page.dbId = "${param.id}";
</script>
			...
			<div class="content">
				...
				<div class="row">
					<div style="text-align: right">
						<a href="../../config/dbconf/list.jsp" class="btn ">返回</a>
					</div>
				</div>
				<div class="row " style="padding-bottom: 15px">
					<div class="span3">
						<span class="label" style="font-size: 15px;">数据库的基本信息</span>
					</div>
				</div>
					...
					<div class="span11" style="">
						<table class="zebra-striped condensed-table bordered-table">
							...
							<tr>
								...
								<td style="text-align: left" id="dbName"></td>
							</tr>
							<tr>
								<td style="text-align: right">
									用户名:
								</td>
								<td style="text-align: left" id="dbUser"></td>
							</tr>
							<tr>
								<td style="text-align: right">
									密码:
								</td>
								<td style="text-align: left" id="dbPwd"></td>
							</tr>
							...
							<tr>
								...
								<td style="text-align: left" id="dbType"></td>
							</tr>
							<tr>
								<td style="text-align: right">
									URL:
								</td>
								<td style="text-align: left" id="dbUrl"></td>
							</tr>
							<tr>
								<td style="text-align: right">
									描述:
								...
								<td style="text-align: left">
									<div class="input">
										<textarea rows="2" cols="100" class="xxlarge" id="dbDesc"></textarea>
									</div>
