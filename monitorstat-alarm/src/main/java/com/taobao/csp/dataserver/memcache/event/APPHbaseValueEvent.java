 ...
 *         上午11:12:21
 */
public class APPHbaseValueEvent implements DataEvent {

	private static final Logger logger = Logger
			.getLogger(APPHbaseValueEvent.class);

	@Override
	public void onEvent(String appName, String propname, String fullName,
			long collectime, Object value) {
		try {
			if (value != null && collectime > 0) {
				...
				MonitorLog.addStat(Constants.DATA_PERSISTENCE_LOG, new String[]{"Hbase_APP","PV"}, new Long[]{1l,System.currentTimeMillis()-time});
				MonitorLog.addStat(Constants.DATA_PERSISTENCE_LOG, new String[] { "Hbase_APP",appName }, new Long[] { 1l,System.currentTimeMillis() - time });
