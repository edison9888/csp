...
public abstract class _WWMessageInterfaceDisp extends Ice.ObjectImpl implements WWMessageInterface
{
    ...
    {
        return SendTipMessage(strCaller, strServiceType, adParam, strToId, strRetMessage, null);
    }
    ...
    public static Ice.DispatchStatus
    ___SendTipMessage(WWMessageInterface __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        Ice.StringHolder strRetMessage = new Ice.StringHolder();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.SendTipMessage(strCaller, strServiceType, adParam, strToId, strRetMessage, __current);
        __os.writeString(strRetMessage.value);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 1:
            {
                return ___SendTipMessage(this, in, __current);
            }
            case 2:
            {
