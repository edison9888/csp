...
public final class WWMessageInterfacePrxHelper extends Ice.ObjectPrxHelperBase implements WWMessageInterfacePrx
{
    ...
    public int
    SendTipMessage(String strCaller, String strServiceType, STADPUSH adParam, String strToId, Ice.StringHolder strRetMessage)
    {
        return SendTipMessage(strCaller, strServiceType, adParam, strToId, strRetMessage, null, false);
    }
    ...
    {
        return SendTipMessage(strCaller, strServiceType, adParam, strToId, strRetMessage, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private int
    SendTipMessage(String strCaller, String strServiceType, STADPUSH adParam, String strToId, Ice.StringHolder strRetMessage, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("SendTipMessage");
                __delBase = __getDelegate(false);
                _WWMessageInterfaceDel __del = (_WWMessageInterfaceDel)__delBase;
                return __del.SendTipMessage(strCaller, strServiceType, adParam, strToId, strRetMessage, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex, null);
