...
public class MonitorDayAo {
	...
	public Map<Integer, MonitorVo> findMonitorCountMapByDate(Integer appid,String date) throws Exception{
		if(dao!=null){
			...
			Map<Integer, MonitorVo> result = dao.findMonitorCountMapByDate(appid, appInfo.getOpsName(),date);
			return result;
		}else{
			return null;
		}
	 ...
	 * @throws Exception
	 */
	public Map<Integer, MonitorVo> findMonitorCountMapByDate(AppInfoPo appInfo,String date) throws Exception{
		if(dao!=null && appInfo != null){
			Map<Integer, MonitorVo> result = dao.findMonitorCountMapByDate(appInfo.getAppId(), appInfo.getOpsName(),date);
			return result;
		}else{
			return null;
		}
	...
	public List<KeyValuePo> findMonitorCountAllByDate(int keyId,Date startDate,Date endDate){
		return dao.findMonitorCountAllByDate(keyId, startDate, endDate);
	}	
